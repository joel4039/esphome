...
class WWALightOutput : public light::LightOutput {
 public:
  ...
  void set_amber_temperature(float *amber){ amber_temperature_ = amber_temperature; }
  ...
  light::LightTraits get_traits() override {
    ...
    traits.set_max_mireds(this->amber_temperature_);
    return traits;
  }
  void write_state(light::LightState *state) override {
    float cwhite, wwhite, amber;
    state->current_values_as_cwww(&cwhite, &wwhite, &amber, this->constant_brightness_);
